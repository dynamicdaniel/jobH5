...
class RightnowUse extends React.Component {
    ...
    constructor(props) {
        ...
        this.cardId = props.numCardDetail.card_id
        this.timecardId = props.numCardDetail.id
        this.title = props.numCardDetail.title
    ...
    componentDidMount(){
        ...
        getBundingdevice({ card_id: this.cardId }).then(data => {
                                ...
                                <Bk>
                                    <Bk height="50%">
                                        <Bk height='70%' display='flex' justifyContent='center' alignItems='flex-start'>
                                            <Bk width="90px" height="90px" img={this.props.numCardDetail.logo} />
